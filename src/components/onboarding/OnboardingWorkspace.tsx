              ...
              return (
                <li key={t.id}>
                  <button
                    ...
                    className={cn(
                      "group flex w-full items-center gap-2.5 border-b border-slate-100 px-3.5 py-2.5 text-left transition-colors duration-150 last:border-b-0",
                  ...
                  >
                    ...
                    <ChevronRight
                      className={cn(
                        ...
                        on && "translate-x-0.5 text-indigo-400",
                      )}
                    />
                  </button>
                </li>
